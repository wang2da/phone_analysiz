...
public class LogWritable implements Writable{
    ...
    private String pl;
    private String ip;
//    private String COLUMN_NAME_SEPARTOR=\\^A;
...
//        return ver+"\001"+s_time+"\001"+en+"\001"+u_uid+"\001"+
//                u_mid+"\001"+u_sd+"\001"+c_time+"\001"+l+"\001"+b_iev+"\001"+b_rst+"\001"+
//                p_ref+"\001"+tt+"\001"+pl+"\001"+ip+"\001"+oid+"\001"+on+"\001"+cua+"\001"+
//                cut+"\001"+pt+"\001"+ca+"\001"+ac+"\001"+kv_+"\001"+du+"\001"+browserName+"\001"+browserVersion+"\001"+
//                osName+"\001"+osVersion+"\001"+country+"\001"+province+"\001"+city+"\001"+p_url;
    }
}
