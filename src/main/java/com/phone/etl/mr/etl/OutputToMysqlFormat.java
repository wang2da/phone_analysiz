...
public class OutputToMysqlFormat extends
        OutputFormat<StatsBaseDimension,ReduceOutput>{
    @Override
    public RecordWriter<StatsBaseDimension, ReduceOutput> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
    ...
    public static class OutputToMysqlRecordWritter extends RecordWriter<StatsBaseDimension,ReduceOutput>{
        ...
        @Override
        public void write(StatsBaseDimension key, ReduceOutput value) throws IOException, InterruptedException {
...
//                String str ="writter_"+ conf.get(kpi.kpiName);
                ...
                EtlToHdfs.IOWriterOutput writter = (EtlToHdfs.IOWriterOutput) classz.newInstance();
