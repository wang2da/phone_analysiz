...
public class NewUserRunner implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        //为结果表中的created赋值
        String created = TimeUtil.parseLong2String(GloadUtils.DEFAULT_DATE_FORMAT);
        conf.set(GloadUtils.RUNNING_DATE,created);
...
//    }
    ...
    private void computeNewTotalUser(Job job) {
        ...
        try {
            //获取运行的日期
            String date = job.getConfiguration().get(GloadUtils.RUNNING_DATE);
